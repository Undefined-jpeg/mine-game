...
For your friends to connect, your router must allow traffic on port **25565**.
...
## Troubleshooting
- **Cannot connect?** Ensure the host's firewall (Windows Firewall, etc.) isn't blocking Java or port 25565.
